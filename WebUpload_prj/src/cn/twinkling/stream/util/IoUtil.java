...
public class IoUtil {
     ...
     * @throws IOException
     */
   // static String uploadusername=UploadHandleServlet.getusername1();
    ...
    public static void storeToken(String key) throws IOException {
    	System.out.println("****IoUtil**key**"+key);
        if (key == null || key.isEmpty())
        {
        	System.out.println("****key == null || key.isEmpty()**");
        	
            return;
        }
        System.out.println("****File f begin**");
      //  Configurations confi =new Configurations();
      //  System.out.println("****uploadusername**"+uploadusername);
        ...
        if (!f.getParentFile().exists())
        {
            ...
            System.out.println("****storeToken(String key) _end**");
            }
