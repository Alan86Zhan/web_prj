...
<html>
  ...
  <body style="background: url(res/222.png);background-size:cover;">
   <center>
	...
	-->
	<br>
	Messages: <a href="http://52.80.17.26:8080/usertag/${usermessage}/uploaded_history.txt" target="_blank">查看上传到服务器上的文件列表</a>
 ...
 */
	var config = {
		...
		//tokenURL : "http://ms-20161210hwnq.lan:8080/webupload_v1.6/stream/tk", /** 根据文件名、大小等信息获取Token的URI（用于生成断点续传、跨域的令牌） */
